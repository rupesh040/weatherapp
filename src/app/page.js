...
try {
  ...
  return (
   ...
   <div class="container w-[100vw] h-[100vh] overflow-hidden flex justify-center items-center ">
    <div class="weather w-80 h-96 bg-white rounded-2xl overflow-hidden flex flex-col justify-between text-[#201f1f] z-10">
        <div className="flex justify-center px-4 py-3 gap-3 bg-[#201f1f] "><input type="text" className="text-[18px] px-2 outline-none bg-transparent text-white" ref={inputRef} placeholder="Enter City Name" autoFocus/> <i class="ri-search-line text-[20px] cursor-pointer text-zinc-50" onClick={()=> search (inputRef.current.value)}></i></div>
